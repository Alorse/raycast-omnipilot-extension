...
export default function TranslateText(props: { arguments: Arguments }) {
  ...
  const isValidLanguage = (text: string): boolean => {
    ...
    const validLanguages = [
      ...
      'norwegian', 'danish', 'finnish', 'polish', 'czech', 'turkish', 'greek',
    ...
    const commonNonLanguageWords = [
      'http', 'https', 'www', 'com', 'org', 'net', 'email', 'password', 
      'username', 'login', 'signup', 'register', 'click', 'here', 'download',
      'install', 'configure', 'settings', 'options', 'preferences', 'file',
      'folder', 'document', 'text', 'copy', 'paste', 'cut', 'save', 'open',
      'close', 'quit', 'exit', 'help', 'about', 'contact', 'support'
    ];
